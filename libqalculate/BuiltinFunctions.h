...
enum {
	...
	FUNCTION_ID_REF = 5001,
	FUNCTION_ID_GAUSSIAN_ELIM = 5002,
...
DECLARE_BUILTIN_FUNCTION(RefFunction, FUNCTION_ID_REF)
DECLARE_BUILTIN_FUNCTION(GaussianElinimationFunction, FUNCTION_ID_GAUSSIAN_ELIM)
